...
export const devices: (Device | MultiDevice)[] = [
  ...
  { name: 'BOMBA RIO SEGUNDO', url: 'https://prueba-labview-default-rtdb.firebaseio.com/BASE_DATOS/ACUEDUCTOALAJUELA/RIOSEG/BOMBA.json', pumpKey: 'DATABOMB', type: 'pump', group: 'RIO SEGUNDO', order: 2 },
  ...
  { name: 'BOMBA LOS LLANOS', url: 'https://prueba-labview-default-rtdb.firebaseio.com/BASE_DATOS/ACUEDUCTOALAJUELA/LOSLLANOS/BOMBA.json', pumpKey: 'DATABOMB', type: 'pump', group: 'los-llanos', order: 2 },
  ...
  // B PRADERA (Sistema multi-bomba)
  {
    ...
    order: 1,
    multiDevices: [
      { name: 'Bomba 1', type: 'pump', key: 'BOMBA1' },
      { name: 'Bomba 2', type: 'pump', key: 'BOMBA2' },
      { name: 'Bomba 3', type: 'pump', key: 'BOMBA3' }
    ]
  }
];
