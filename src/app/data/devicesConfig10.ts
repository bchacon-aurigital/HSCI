...
export const subsystems: Subsystem[] = [
  ...
  {
    name: 'citizen',
    displayName: 'Sistema La Ribera',
    devices: citizenDevices,
  },
  {
    name: 'epa',
    displayName: 'Sistema Asunción',
    devices: epaDevices,
  },
];
