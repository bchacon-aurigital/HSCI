...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const validCodes = ['ALSFH', 'asroa2537', 'codigo2', 'alajuela2025', 'coyol2025', 'catsa2025', 'AQG2025', 'sanmarcanda2025', 'belen2025', 'ACP2026', 'villasol2026', 'app2026', 'ALDN2026', 'ASPB2026', 'APT2026', 'ABCN2026'];
