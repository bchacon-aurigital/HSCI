...
interface PumpData {
  fecha: string;
  [key: string]: any;  // Allow for various pump keys (BOMBA1, BOMBA2, etc.)
}

interface WellData {
  fecha: string;
  [key: string]: any;  // Allow for well pump keys (BOMBAH22, BOMBAH27, etc.)
}
...
// Exportamos el componente PumpIndicator para usarlo en MultiDeviceCard
...
// Exportamos el componente WellIndicator para usarlo en MultiDeviceCard
export const WellIndicator = ({ status }: { status: number }) => {
  ...
  return (
    <svg viewBox="0 0 100 120" className="w-32 h-48 mx-auto">
      ...
      {/* Filtro/rejilla superior con patrón de malla */}
      ...
      {/* Líneas verticales (impulsor/etapas) - más cortas y centradas */}
